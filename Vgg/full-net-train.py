...
ProbFile = "probFull.txt"
TrainProbFile = "trainProbFull.txt"
top5ProbFile = "top5ProbFull.txt"
top5TrainProbFile = "top5TrainProbFull.txt"
    ...
    try:
        ...
        for epoch in range(max_steps):
            ...
            if epoch % eval_every_n == 0:
                ...
                print("epoch: ",epoch, "; train set acc:", train_acc,  "; train set loss: ", total_loss)
